...
// REMOVED: Cloud Logging transport causes duplicate logs on Cloud Run
// Cloud Run automatically captures stdout and sends to Cloud Logging.
// Using LoggingWinston ON TOP of Console transport causes every log to appear TWICE.
// Only use LoggingWinston if NOT on Cloud Run (e.g., GKE, Compute Engine without stdout capture)
//
// const useCloudLogging = process.env.USE_CLOUD_LOGGING !== 'false';
